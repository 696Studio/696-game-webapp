    ...
    return (
      <div style={{position:"relative", width:"100%", height:"100%"}}>
        ...
        {true && (
          ...
          >
            <span role="img" aria-label="Attack" style={{ fontStyle: "normal", fontSize: 9 }}>⚔</span><span style={{ fontSize: 9, fontWeight: 800, marginLeft: 4 }}>{shownAtk}</span> <span style={{ opacity: 0.7 }}>•</span> <span role="img" aria-label="Health" style={{ fontStyle: "normal", fontSize: 9 }}>❤</span><span style={{ fontSize: 9, fontWeight: 800, marginLeft: 4 }}>{shownHp}</span>
          </div>
        )}
      </div>
    );
