...
const hpPct = useMemo(() => {
    ...
    return (
      <div className={["bb-slot", isDyingUi ? "is-dying" : "", isVanish ? "is-vanish" : ""].join(" ")} data-unit-id={renderUnit?.instanceId} data-bb-unit-id={renderUnit?.instanceId}>
      ...
      <div
        ...
        data-slot={fallbackId}

        data-bb-slot={fallbackId}

        data-unit-id={renderUnit?.instanceId}

        data-bb-unit-id={renderUnit?.instanceId}
        className={[
          "bb-card",
